...
class GeneralInformation extends Component{
    ...
    return (
        <div className="d-flex flex-row justify-content-center mb-5">
          <ul className="list-group list-group-horizontal-sm shadow bg-white rounded">
            <li className="list-group-item text-secondary border-right-0"><b>{this.state.info[0]}</b> <br></br> Notas recolectadas  </li>
            <li className="list-group-item text-secondary border-right-0"><b>{this.state.info[1]}</b> <br></br> Autores/as recolectados </li>
            <li className="list-group-item text-secondary border-right-0"><b>{this.state.info[2]} meses</b> <br></br> Tiempo de observación </li>
            <li className="list-group-item text-secondary border-right-0"><b>{this.state.info[3]} medios</b> <br></br> Plataformas en observación </li>
          </ul>
        </div>
    )
  }
  ...
  ObtenerVariables(consulta1, consulta2, consulta3, consulta4){
    ...
    this.setState({ info: [cantArticulos, cantAutores, cantMeses, cantMedios] })
  }
