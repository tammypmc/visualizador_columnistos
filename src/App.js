...
class App extends Component {
  ...
  render() {
    ...
    return ( < div className = "container-fluid  p-0" >
      ...
      <
      Navbar seleccionFecha = {
        this.manejoDeFechas
      }
      seleccionAnio = {
        this.manejoDeAnio
      }
      enlaceAnios = "https://apicolumnistos.tedic.net/api/anios_disponibles" > < /Navbar> <
      InfoColumnistos seleccionAnio = {
        this.manejoDeAnio
      }
      enlaceAnios = "https://apicolumnistos.tedic.net/api/anios_disponibles" / >


      <
      GeneralInformation enlace1 = "https://apicolumnistos.tedic.net/api/cantidad_articulos"
      enlace2 = "https://apicolumnistos.tedic.net/api/total_autores"
      enlace3 = "https://apicolumnistos.tedic.net/api/cantidad_meses"
      enlace4 = "https://apicolumnistos.tedic.net/api/cantidad_medios" / >
      ...
      <
      GraficoPromedioGeneral enlace = "https://apicolumnistos.tedic.net/api/periodicos"
      ...
      <
      GraficoBarraSemana id = "graficosemana"
      enlace = {
        graficoSemana
      }
      titulo = "¿Cómo se distribuyen por dia de la semana?" / >
      <
      /div> <
      /div>
      ...
      div class = "shadow w-100 p-3 bg-white" >
      <
      GraficoBarra id = "semana"
      enlace = {
        graficoSemanaPeriodico
      }
      ...
      div class = "shadow w-100 p-3 bg-white" >
      <
      GraficoStepLine enlace = {
        distribucionSemanaAnio
      }
      id = "GraficoStepLine" / >
      ...
      div className = "shadow p-3 bg-white " >
      <
      GraficoDiasSinMujeres id = "diasSinMujeres"
      enlace = "https://apicolumnistos.tedic.net/api/dias_sin_mujeres"
      enlaceDias = "https://apicolumnistos.tedic.net/api/dias_disponibles"
      enlaceMedio = "https://apicolumnistos.tedic.net/api/dias_sin_mujeres_medio/"
      listaMedios = {
        ["abc", "lanacionpy", "ultimahora"]
      }
      titulo = "Días sin mujeres" / >
      <
      /div> <
      /div> <
      /div>
